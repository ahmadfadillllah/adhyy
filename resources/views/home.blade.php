...
<meta name="description" content="Hai, perkenallkan nama saya Ahmad Fadillah">
<meta name="author" content="Ahmad Fadillah">

<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">

<title>My Portfolio | Ahmad Fadillah</title>
...
<body>
	...
	<div class="edrea_tm_all_wrap" data-magic-cursor="show" data-enter="fadeInUp" data-exit="">
		...
		<div class="edrea_tm_settings">
			<div class="icon">
				<img class="svg" src="{{ asset('home') }}/img/setting.svg" alt="" />
				<a class="link" href="#"></a>
			</div>
			<div class="wrapper">
				...
				<ul class="cursor">
					...
					<li><a class="hide" href="#"><img class="svg" src="{{ asset('home') }}/img/arrow.svg" alt="" /></a></li>
				</ul>
			</div>
		</div>
		<!-- /SETTINGS -->
		...
		<div class="edrea_tm_topbar">
			<div class="topbar_inner">
				<div class="logo">
					<a href="javascript:void(0);"><h5>My Portfolio</h5></a>
				</div>
				<div class="trigger">
			...
			<div class="edrea_tm_section animated" id="home">
				<div class="section_inner">
					<div class="edrea_tm_home">
						<h3 class="name">Ahmad <span class="coloring">Fadillah</span></h3>
						<h3 class="job">
			...
			<div class="edrea_tm_section" id="about">
				<div class="section_inner">
					<div class="edrea_tm_about">
						<div class="left">
							<div class="image">
								<img src="{{ asset('home') }}/img/thumbs/1-1.jpg" alt="" />
								<div class="main" data-img-url="{{ asset('home') }}/img/about/ahmadfadillah.jpg"></div>
							</div>
						</div>
						<div class="right">
							<div class="short">
										...
										<div class="left_inner">
											<div class="author">
												<div class="avatar_image">
													<img src="{{ asset('home') }}/img/about/ahmadfadillah.jpg" alt="" />
													<div class="main" data-img-url="{{ asset('home') }}/img/about/ahmadfadillah.jpg"></div>
												</div>
												<div class="short">
													<h3 class="name">Ahmad <span class="coloring">Fadillah</span></h3>
												...
												<ul>
													...
													<li>
														<div class="list_inner">
															...
															<span><a href="#">+62 85213-067-944</a></span>
														</div>
													</li>
													<li>
														<div class="list_inner">
															<i class="icon-mail-1"></i>
															<span><a href="mailto:example@gmail.com">ahmadfadillah502@gmail.com</a></span>
														</div>
													</li>
												</ul>
											</div>
									...
									<div class="right">
										<div class="right_inner">
											<div class="biography">
												...
												<div class="text">
													<p>Halo, nama Saya <span>Ahmad Fadillah.</span> Biasa dipanggil Adhy, Saya lulusan dari Universitas Muslim Indonesia Fakultas Ilmu Komputer Program Studi Teknik Informatika. Saya Lulus pada bulan Juli tahun 2022 dan meraih predikat Cumlaude dengan IPK 3.88. Selama 5 tahun berpengalaman di bidang IT, Saya juga menguasai beberapa keahlian seperti Project Management, Laravel, PHP, IT Support, Graphic Design, dan Database.</p>
												</div>
											</div>
											<div class="service">
												<div class="about_title">
												...
												<div class="list">
													<ul>
														<li><i class="icon-right-dir"></i>Project Management</li>
														<li><i class="icon-right-dir"></i>Web Developer</li>
														<li><i class="icon-right-dir"></i>Laravel</li>
														<li><i class="icon-right-dir"></i>Database</li>
														<li><i class="icon-right-dir"></i>Graphic Designer</li>
                                                        <li><i class="icon-right-dir"></i>IT Support</li>
                                                        <li><i class="icon-right-dir"></i>Microsoft</li>
													</ul>
												</div>
											</div>
											...
											{{-- <div class="partners">
												...
												<div class="list">
													<ul>
														<li>
															<div class="list_inner">
																<img src="{{ asset('home') }}/img/partners/1.png" alt="" />
																<a class="cavani_tm_full_link" href="#"></a>
															</div>
														</li>
														<li>
															<div class="list_inner">
																<img src="{{ asset('home') }}/img/partners/2.png" alt="" />
																<a class="cavani_tm_full_link" href="#"></a>
															</div>
														</li>
														<li>
															<div class="list_inner">
																<img src="{{ asset('home') }}/img/partners/3.png" alt="" />
																<a class="cavani_tm_full_link" href="#"></a>
															</div>
														</li>
														<li>
															<div class="list_inner">
																<img src="{{ asset('home') }}/img/partners/4.png" alt="" />
																<a class="cavani_tm_full_link" href="#"></a>
															</div>
														</li>
													</ul>
											...
											<div class="testimonial">
												<div class="about_title">
													<h3><span>My <span class="coloring">Feedback</span></span></h3>
												</div>
												<div class="list">
							...
							<div class="swiper-container">
								<div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
										<div class="list_inner">
											<div class="image">
												<img src="{{ asset('app') }}/assets/images/others/{{ $p->gambar }}" alt="" />
												<div class="main" data-img-url="{{ asset('app') }}/assets/images/others/{{ $p->gambar }}"></div>
												<a class="edrea_tm_full_link news_popup" href="{{ $p->id }}"></a>
											</div>
											<div class="details">
												<h3><a href="#">{{ $p->judul }}</a></h3>
												<span><a href="#">{{ $p->kategori }}</a></span>
											</div>
							...
							<div class="left">
								<ul>
									...
									<li>
										<div class="list_inner">
											<i class="icon-phone"></i>
											<span><a href="#">+62852 1306 7944</a></span>
										</div>
									</li>
									<li>
										<div class="list_inner">
											<i class="icon-mail-1"></i>
											<span><a href="mailto:ahmadfadillah502@gmail.com">ahmadfadillah502@gmail.com</a></span>
										</div>
									</li>
									<li>
										<div class="list_inner">
											<i class="icon-instagram-rect"></i>
											<span><a href="https://www.instagram.com/ahmad.fadilllah">ahmad.fadilllah</a></span>
										</div>
									</li>
								</ul>
							</div>
							<div class="right">
								<div class="fields">
									<form action="/" method="post" class="contact_form" id="contact_form">
										...
										<div class="edrea_tm_button">
											<a id="send_message" href="https://wa.me/6285213067944">Send Message</a>
										</div>
