                    ...
                    <ul class="side-nav-menu scrollable">
                        <li class="nav-item dropdown open">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active">
                                    <a href="{{ route('dashboard.index') }}">Default</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <div class="main-content">
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <button class="btn btn-primary btn-tone m-r-5" data-toggle="modal"
                                        data-target="#tambahProject">Tambah Portfolio</button>
                                </div>
                                <!-- Modal -->
                                <div class="modal fade" id="tambahProject">
                                    ...
                                    <div class="m-t-25">
                                        <div class="card" style="max-width: 370px">
                                            <img class="card-img-top"
                                                src="{{ asset('app') }}/assets/images/others/{{ $p->gambar }}" alt="">
                                            <div class="card-body">
                                                <h4 class="m-t-10">{{ $p->judul }}</h4>
                                                <p class="card-text">{{ $p->deskripsi }}</p>
                                                <div class="m-t-20">
                                                    <a href="" class="btn btn-warning btn-tone m-r-5">Edit</a>
                                                    <a href="{{ route('dashboard.delete', $p->id) }}" class="btn btn-danger btn-tone m-r-5">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
